/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bee17b5bf0efaaeeceb0a245c05a323a)
// Runtime types generated with workerd@1.20260903.1 2026-09-04 nodejs_compat
interface __BaseEnv_Env {
	AUTH_DB: D1Database;
	ENVIRONMENT: "production";
	AWS_REGION: "ap-northeast-1";
	BETTER_AUTH_URL: "https://strands-kamada-hono.kmdworksnative.workers.dev";
	AWS_ACCESS_KEY_ID: string;
	AWS_SECRET_ACCESS_KEY: string;
	AGENTCORE_RUNTIME_ARN: string;
	AGENT_API_TOKEN_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "AWS_REGION" | "BETTER_AUTH_URL" | "AWS_ACCESS_KEY_ID" | "AWS_SECRET_ACCESS_KEY" | "AGENTCORE_RUNTIME_ARN" | "AGENT_API_TOKEN_SECRET" | "BETTER_AUTH_SECRET">> {}
}
